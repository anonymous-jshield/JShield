...
public class JSProcessor implements Runnable{
    ...
    public JSProcessor(FeaturesDBHandler db, int malicious){
    ...
    public JSProcessor(String dir, FeaturesDBHandler db, int malicious){
    	this.dir = dir;
    	this.fdbh = db;
    	this.isMalicious = malicious;
		this.handled_files = new HashSet<String>();
    	init();
    }
    public void run(){
    ...
    //The files' name should be ended with "src"
    	...
    	for(File file:entries){
    		...
    		//i.e. xxxx.com.src1
 	        ...
 	        //Extract the Source Codes from file
 	 		contents = extractSourceCodeFromJSFile(file,links);
    ...
    public Vector<String> extractSourceCodeFromJSFile(File file, Vector<String> links) throws IOException{
